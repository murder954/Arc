package ru.sfedu.petclinic.lab3.strat1.util;
...
import ru.sfedu.petclinic.lab3.strat1.model.*;
import ru.sfedu.petclinic.util.ConfigUtils;

import java.io.File;
import java.io.IOException;

import static ru.sfedu.petclinic.Constans.HB_CFG_31;
...
public class HibernateUtil {
    ...
    static {
        try {
            configPath = con.getConfigurationEntry(HB_CFG_31);
        } catch (IOException e) {
