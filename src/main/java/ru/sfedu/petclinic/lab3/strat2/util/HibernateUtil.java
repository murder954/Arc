package ru.sfedu.petclinic.lab3.strat2.util;

import org.hibernate.SessionFactory;
import org.hibernate.boot.registry.StandardServiceRegistryBuilder;
import org.hibernate.cfg.Configuration;
import org.hibernate.service.ServiceRegistry;
import ru.sfedu.petclinic.lab3.strat2.model.*;
import ru.sfedu.petclinic.util.ConfigUtils;

import java.io.File;
import java.io.IOException;

import static ru.sfedu.petclinic.Constans.HB_CFG_32;
...
public class HibernateUtil {
    ...
    static {
        try {
            configPath = con.getConfigurationEntry(HB_CFG_32);
        } catch (IOException e) {
