...
public class Cat extends Pet {
    ...
    public Cat(String name, String gender, double weight, String feedType, int age, String nameOfDisease, boolean afraidDogs, boolean isCalm) {
        super(name, gender, weight, feedType, Constans.TypePet.CAT, age, nameOfDisease);
