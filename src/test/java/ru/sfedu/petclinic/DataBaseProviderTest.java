...
class DataBaseProviderTest {
    ...
    static Cat test_pet1 = new Cat("Vasiliy", "male", 3.4, "potato", 1, "stomach_ache", false, false);
    static Cat test_pet2 = new Cat("Vasilisa", "female", 6.07, "premium_feed_with_meat", 3, "ill", true, true);
    static Dog test_pet3 = new Dog("Muhtar", "male", 21.07, "feed_with_meat_taste", 1, "break paw", true);
    static Fish test_pet4 = new Fish("Goldy", "female", 0.3, "bread", 2, "lepidorthosis", "fresh_water");
    static Bird test_pet5 = new Bird("Teo", "male", 0.7, "worms", 1, "brake wing", false);
    static Dog test_pet6 = new Dog("Biba", "female", 33.1, "Meal", 6, "ill", false);
    static Fish test_pet7 = new Fish("Nemo", "male", 0.8, "worms", 2, "lepidorthosis", "sea");
    ...
    static Feed test_feed1 = new Feed("premium_feed_with_meat", 546.34, 500, Constans.TypePet.CAT);
    static Feed test_feed2 = new Feed("seed", 203.0, 1000, Constans.TypePet.BIRD);
    static Feed test_feed3 = new Feed("porridge_with_meal", 563, 1000, Constans.TypePet.DOG);
    ...
    static EnvironmentVariant test_variant1 = new EnvironmentVariant("aquarium", true, "oxygen_pump", "decorative_castle", 2990.0, Constans.TypePet.FISH);
    static EnvironmentVariant test_variant2 = new EnvironmentVariant("Cell", true, "Water tank", "perch", 499.0, Constans.TypePet.BIRD);
    static EnvironmentVariant test_variant3 = new EnvironmentVariant("Couch", true, "NONE", "PILLOW", 999.0, Constans.TypePet.CAT);
    ...
    void savePetNegative() throws Exception {
        ...
        assertEquals("Pet with this id has been saved previously", exception.getMessage());
    }
    ...
    void getFeedRecordByIDNegative() throws Exception {
        ...
        assertEquals("there is no feed with this id", exception.getMessage());
    }
    ...
    void getDrugRecordByIDNegative() throws Exception {
        ...
        assertEquals("there is no drug with this id", exception.getMessage());
    }
    ...
    void getDiseaseRecordByIDNegative() throws Exception {
        ...
        assertEquals("there is no disease with this id", exception.getMessage());
    }

    @Test
    void getEnvironmentVariantRecordByIDPositive() throws Exception {
        dataProvider.saveEnvironmentVariantRecord(test_variant3);
        assertNotNull(dataProvider.getEnvironmentVariantRecordByID(test_variant3.getId()));
    }
    ...
    void getEnvironmentVariantRecordByIDNegative() throws Exception {
        ...
        assertEquals("there is no variant with this id", exception.getMessage());
    }
    ...
    void deleteEnvironmentVariantRecordPositive() throws Exception {
        Exception exception = assertThrows(Exception.class, () -> {
            ...
            dataProvider.deleteEnvironmentVariantRecord(test_variant2.getId());
            dataProvider.getEnvironmentVariantRecordByID(test_variant2.getId());
        });
        assertEquals("there is no variant with this id", exception.getMessage());
    }
