...
class DataProviderCSVTest {
    ...
    static Dog test_pet3 = new Dog("Muhtar", "male", 21.07, "feed_with_meat_taste", 1, "break_paw", true);
    static Fish test_pet4 = new Fish("Goldy", "female", 0.3, "bread", 2, "lepidorthosis", "fresh_water");
    static Bird test_pet5 = new Bird("Teo", "male", 0.7, "worms", 1, "brake_wing", false);
